...
class NowPlayingMoviesResponseDto {
  ...
  NowPlayingMoviesResponseDto.fromJson(Map<String, dynamic> json) {
    page = json['page'];
  ...
  NowPlayingMoviesResponseEntity toEntity() {
    return NowPlayingMoviesResponseEntity(
      page: page ?? 0,
...
class Results {
  ...
  ResultsNowPlayingMovies toEntity() {
    return ResultsNowPlayingMovies(
      adult: adult ?? false,
